...
Product.find_by(name: 'Caderno universitário 10 materias').images.attach(io: File.open('./public/caderno-10-u.jpg'), filename: 'caderno-1-u.jpg')
Product.find_by(name: 'Caderno universitário 1 materia').images.attach(io: File.open('./public/Caderno_u_1m.jpg'), filename: 'Caderno_u_1m.jpg')
