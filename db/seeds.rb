...
Product.find_by(name: 'Caneta Azul').profile_picture.attach(io: File.open('./public/product-1-1.jpg'), filename: 'product-1-1.jpg')
Product.find_by(name: 'Caneta Azul').profile_picture.attach(io: File.open('./public/product-1-2.jpg'), filename: 'product-1-2.jpg')
